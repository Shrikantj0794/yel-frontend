      ...
      <nav className={`bg-[#075985] mt-3 h-screen fixed text-white dark:bg-ocean-800 min-h-screen transition-all duration-300 ${isClosed ? "w-20" : "w-64"} p-4`}>
        ...
        <div className={`mt-10 ${isClosed ? "mt-14" : "mt-10"}`}>
          <ul className="space-y-4">
            <li>
              <Link to="/superAdmin" className={`flex items-center space-x-4 hover:text-white hover:bg-sky-900 dark:hover:bg-ocean-700 p-2 rounded-md ${isActiveLink('/superAdmin') ? 'bg-sky-900' : ''}`}>
            ...
            <li>
              <Link to="/superAdmin/department" className={`flex items-center space-x-4 hover:text-white hover:bg-sky-900 dark:hover:bg-ocean-700 p-2 rounded-md ${isActiveLink('/superAdmin/department') ? 'bg-sky-900' : ''}`}>
            ...
            {user?.role === 'admin' && (
              <li>
                <Link to="/Admindashboard" className={`flex items-center space-x-4 hover:text-black hover:bg-gray-100 dark:hover:bg-ocean-700 p-2 rounded-md ${isActiveLink('/Admindashboard') ? 'bg-teal-500' : ''}`}>
